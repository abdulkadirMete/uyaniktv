...
/* you can change this */
	$download_url = "https://ovhde0.uyanik.tv/android/conf/tvguide.zip"; // url to zip file you want to download
...
// extract file content 
	...
	if ($res === TRUE) {
	  ...
	  if ($delete == "yes") { unlink($file); unlink($jsonFile); } else { echo "remember to delete <strong>$file</strong> & <strong>$script</strong>!"; }
